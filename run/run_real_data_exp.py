...
# @FileName     : run_real_data_exp.py
# @Time         : Created at 2019-08-03
...
dataset = 'amazon_app_movie'  # oracle, image_coco, emnlp_news, amazon_app_movie, mr_sl15, mr_sl15_cat0
vocab_size = 6273  # oracle: 5000, coco: 6613, emnlp: 5255, amazon_app_movie: 6273
max_seq_len = 40
temp_adpt = 'exp'
temperature = [1, 100, 1000]
tips = '[Compare Exp-Real data] EvoGAN with temp{}, dataset={}, with head_size=512'.format(temperature, dataset)
