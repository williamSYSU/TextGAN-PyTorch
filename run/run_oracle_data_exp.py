...
loss_type = ['ragan', 'ragan', 'ragan', 'ragan']
mu_type = ['ragan rsgan', 'ragan rsgan', 'ragan rsgan', 'ragan rsgan']
eval_type = 'Ra'
ADV_train_epoch = 2500
tips = '[Compare Exp] EvoGAN (seq_len=20), compare n_parent. [Current] n_parent = {}. [Param] eval_type = Ra, loss_type = ragan, mu_type = ragan rsgan'
