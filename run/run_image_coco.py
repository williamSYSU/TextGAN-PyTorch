...
dataset = 'image_coco'  # image_coco
temp_adpt = 'exp'
temperature = [100]
tips = '[Real data-Image COCO] EvoGAN with temp{}, dataset={}, with head_size=256'.format(temperature, dataset)
